...
var grammar = {
    ...
    {"name": "identword", "symbols": [(lexer.has("KW_SHRIMP") ? {type: "KW_SHRIMP"} : KW_SHRIMP)], "postprocess": d => "shrimp"},
    ...
    {"name": "primary", "symbols": ["dropexpr"], "postprocess": id},
    ...
    {"name": "assignment", "symbols": ["identword", (lexer.has("KW_IS") ? {type: "KW_IS"} : KW_IS), "expr"], "postprocess": 
    ...
    {"name": "funccall", "symbols": [(lexer.has("KW_HOWBOUT") ? {type: "KW_HOWBOUT"} : KW_HOWBOUT), "identword", (lexer.has("KW_WITH") ? {type: "KW_WITH"} : KW_WITH), "arglist"], "postprocess":  
        d => ({ type: "Call", name: d[1], args: d[3] }) 
        },
    {"name": "funccallexpr", "symbols": [(lexer.has("KW_HOWBOUT") ? {type: "KW_HOWBOUT"} : KW_HOWBOUT), "identword", (lexer.has("KW_WITH") ? {type: "KW_WITH"} : KW_WITH), "arglist"], "postprocess":  
        d => ({ type: "Call", name: d[1], args: d[3] }) 
        },
    ...
    {"name": "eskyitem", "symbols": [(lexer.has("BLOODY_ITEM") ? {type: "BLOODY_ITEM"} : BLOODY_ITEM)], "postprocess": d => ({ type: "String", value: d[0].value })},
    {"name": "eskyitem", "symbols": [(lexer.has("NUMBER") ? {type: "NUMBER"} : NUMBER)], "postprocess": d => ({ type: "Number", value: parseFloat(d[0].value) })},
    {"name": "eskyitem", "symbols": [(lexer.has("STRING") ? {type: "STRING"} : STRING)], "postprocess": d => ({ type: "String", value: JSON.parse(d[0].value) })},
    ...
    {"name": "dropexpr", "symbols": [(lexer.has("KW_DROP") ? {type: "KW_DROP"} : KW_DROP), (lexer.has("KW_THE") ? {type: "KW_THE"} : KW_THE), (lexer.has("KW_LAST") ? {type: "KW_LAST"} : KW_LAST), (lexer.has("KW_SNAG") ? {type: "KW_SNAG"} : KW_SNAG), (lexer.has("KW_FROM") ? {type: "KW_FROM"} : KW_FROM), (lexer.has("IDENT") ? {type: "IDENT"} : IDENT)], "postprocess": 
        d => ({ type: "Pop", target: d[5].value, position: "last" })
        },
    {"name": "dropexpr", "symbols": [(lexer.has("KW_DROP") ? {type: "KW_DROP"} : KW_DROP), (lexer.has("KW_THE") ? {type: "KW_THE"} : KW_THE), (lexer.has("KW_FIRST") ? {type: "KW_FIRST"} : KW_FIRST), (lexer.has("KW_SNAG") ? {type: "KW_SNAG"} : KW_SNAG), (lexer.has("KW_FROM") ? {type: "KW_FROM"} : KW_FROM), (lexer.has("IDENT") ? {type: "IDENT"} : IDENT)], "postprocess": 
        d => ({ type: "Pop", target: d[5].value, position: "first" })
        },
